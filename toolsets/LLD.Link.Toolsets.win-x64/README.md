...
**Source:** https://github.com/DotNet-AGPL/PublishAotCross.Tools/tree/main/toolsets/LLD.Link.Toolsets.win-x64
...
This package automatically sets the `LLDLinkToolsetsWinX64Dir` MSBuild property
